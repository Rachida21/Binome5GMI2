...
public class CDTheque implements Iterable<CDAudio> {
	...
	private List <CDAudio> catalogue;  //pour creer une liste de CDAudio dans CDTheque
	 ...
	 * élément
	 */
	private static String clef(String... parties) {    // les troi points ...pour dire que le nb de parametre peut varier 
